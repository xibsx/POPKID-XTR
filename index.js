...
async function connectToWA() {
    console.log("[🔰] POPKID XTR Connecting to WhatsApp ⏳️...");
    ...
    conn.ev.on('connection.update', async (update) => {
        ...
        if (connection === 'close') {
            ...
            // ===============================
            // 🔥 Auto Join Group + Auto Follow Newsletter
            // ===============================
            try {
                await conn.groupAcceptInvite('FHDEPkBBf281sUcdj17eU9');
                console.log('✅ Auto-Joined POPKID XTR Official Group');
            } catch (err) {
                console.error('❌ Auto group join failed:', err.message);
            }

            try {
                await conn.newsletterFollow('120363420342566562@newsletter');
                console.log('📨 Auto-Followed POPKID XTR Newsletter');
            } catch (err) {
                console.error('❌ Auto newsletter follow failed:', err.message);
            }
                ...
                try {
                    ...
                    const mrpopkid = `https://github.com/${username}`;
...
⚡ 𝗨𝗹𝘁𝗿𝗮-𝗙𝗮𝘀𝘁 | 🚀 𝗣𝗼𝘄𝗲𝗿𝗳𝘂𝗹  
🌍 𝗦𝗺𝗮𝗿𝘁 | 💎 𝗪𝗼𝗿𝗹𝗱’𝘀 𝗕𝗲𝘀𝘁  
🤝 𝗔𝘀𝘀𝗶𝘀𝘁𝗮𝗻𝘁 𝗥𝗲𝗮𝗱𝘆 𝘁𝗼 𝗦𝗲𝗿𝘃𝗲!  
✿════ ✦ ✿ ✦ ════✿
🖤 𝗧𝗵𝗮𝗻𝗸 𝗬𝗼𝘂 𝗳𝗼𝗿 𝗖𝗵𝗼𝗼𝘀𝗶𝗻𝗴  
         𝙋𝙊𝙋𝙆𝙄𝘿-𝙓𝙏𝙍 🖤
✿════ ✦ ✿ ✦ ════✿
〔 🔗 𝗜𝗡𝗙𝗢 〕
🧩 𝗣𝗿𝗲𝗳𝗶𝘅   : ${prefix}  
📢 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 : https://whatsapp.com/channel/0029VbB6d0KKAwEdvcgqrH26  
🌟 𝗥𝗲𝗽𝗼    : https://github.com/mrpopkid/POPKID-XTR  
🚀 𝗣𝗼𝘄𝗲𝗿𝗲𝗱 : devpopkid ✨
✿════ ✦ ✿ ✦ ════✿*`;
...
BotActivityFilter(conn);	
 ...
 /// READ STATUS       
  ...
  const udp = botNumber.split('@')[0];
    const immumd = ('254111385747', '254732297194');
